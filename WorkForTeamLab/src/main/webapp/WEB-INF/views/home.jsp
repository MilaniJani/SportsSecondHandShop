		...
		　<c:forEach var="prd" items="${productList }">
         <div style="display: inline-block; width: 25%; padding: 5px">
            <div class="card h-100">
              <a href="product/goPdView?pdNum=${prd.prod_num}"><img class="card-img-top" src="<c:url value="product/download?pdNum=${prd.prod_num}"/>" alt=""></a>
              <div class="card-body">
                <h5 class="card-title">
                  <a href="product/goPdView?pdNum=${prd.prod_num}">${prd.prod_name}</a>
                </h5>
